...
class continuumEnv(gym.Env):
    ...
    def step_error_comparison(self,u):
    ...
    def step_minus_euclidean_square(self,u):
        x,y,goal_x,goal_y = self.state
    ...
    def step_minus_weighted_euclidean(self,u):
        x,y,goal_x,goal_y = self.state
    ...
    def step_distance_based(self,u):
        x,y,goal_x,goal_y = self.state
    ...
    def reset(self):
       ...
       T3_cc = three_section_robot(self.kappa1, self.kappa2, self.kappa3, self.l) 
       ...
       T3_target = three_section_robot(self.target_k1,self.target_k2,self.target_k3, self.l) 
